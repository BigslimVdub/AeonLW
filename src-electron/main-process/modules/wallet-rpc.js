...
export class WalletRPC {
        ...
        return new Promise((resolve, reject) => {
            ...
            crypto.randomBytes(64+64+32, (err, buffer) => {
                ...
                if (process.platform === "win32") {
                    this.walletRPCProcess = child_process.spawn(path.join(__aeon_bin, "aeon-wallet-rpc.exe"), args)
                } else {
                    this.walletRPCProcess = child_process.spawn(path.join(__aeon_bin, "aeon-wallet-rpc"), args, {
                        detached: true
                    })
                }
    ...
    handle(data) {
        ...
        switch (data.method) {
            ...
            case "restore_deterministic_wallet":
        ...
        return new Promise((resolve, reject) => {
            ...
            Promise.all([
                ...
                if(wallet.address_list.unused.length < num_unused_addresses &&
                   !wallet.address_list.primary[0].address.startsWith("Wt") &&
                   !wallet.address_list.primary[0].address.startsWith("Wz") &&
                   !wallet.address_list.primary[0].address.startsWith("Xn")) {
    ...
    listWallets(legacy=false) {
        ...
        if(legacy) {
            ...
            legacy_paths = ["C:\\ProgramData\\aeon", "C:\\ProgramData\\AeonLW"]
            } else {
            legacy_paths = [path.join(os.homedir(), "aeon-wallet-cli"), path.join(os.homedir(), "AeonLW")]
            }
