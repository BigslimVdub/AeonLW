        ...
        <div class="infoBoxBalance">
            <div class="infoBox">
                <div class="infoBoxContent">
                    ...
                    <div class="value"><span><FormatAeon :amount="info.balance" /></span></div>
                </div>
            </div>
        </div>
        ...
        <div>
            <div class="infoBox">
                <div class="infoBoxContent">
                    ...
                    <div class="value"><span><FormatAeon :amount="info.unlocked_balance" /></span></div>
                </div>
            </div>
        </div>
...
import FormatAeon from "components/format_Aeon"
        ...
        doChangePassword () {
            ...
            if(new_password == old_password) {
                ...
                this.$q.notify({
                    type: "negative",
                    timeout: 1000,
                    message: "OOPS! New passwords do not match!"
                })
            } else {
